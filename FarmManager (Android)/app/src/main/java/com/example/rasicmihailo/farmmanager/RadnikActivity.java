...
public class RadnikActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_radnik);
                        ...
                        if(task.isSuccessful()){
                            ...
                            if(task.getResult().exists()){
                                ...
                                if(zaposljen.matches("ne")){
                                    startActivity(new Intent(RadnikActivity.this, MainActivity.class));
                                    finish();
                                }

                            }else{
                                Toast.makeText(RadnikActivity.this, "NE POSTOJI", Toast.LENGTH_LONG).show();
                            }
    ...
    public void proveriZaposljenje(){ // da li je dobio otkaz
    ...
    public void setLocale(String lang) {
        ...
        Intent refresh = new Intent(this, RadnikActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.radnik, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        int id = item.getItemId();
         ...
         if (id == R.id.nav_radnik_poslovi) {
            fragmentManager.beginTransaction()
                    .replace(R.id.radnik_nav, new PosloviRadnikActivity())
                    .commit();
        } else if (id == R.id.nav_pregled_gazdinstva) {
            fragmentManager.beginTransaction()
                    .replace(R.id.radnik_nav, new PregledGazdinstvaActivity())
                    .commit();
        }else if (id == R.id.nav_vremenska_prognoza) {
            fragmentManager.beginTransaction()
                    .replace(R.id.radnik_nav, new VremenskaPrognoza())
                    .commit();
        }  else if (id == R.id.nav_resursi_stoka) {
             fragmentManager.beginTransaction()
                     .replace(R.id.radnik_nav, new ResursiStoka())
                     .commit();
         }else if (id == R.id.nav_resursi_njive) {
             fragmentManager.beginTransaction()
                     .replace(R.id.radnik_nav, new ResursiNjive())
                     .commit();
         }else if (id == R.id.nav_resursi_mehanizacija) {
             fragmentManager.beginTransaction()
                     .replace(R.id.radnik_nav, new ResursiMehanizacija())
                     .commit();
         }else if (id == R.id.nav_resursi_plodovi) {
             fragmentManager.beginTransaction()
                     .replace(R.id.radnik_nav, new ResursiPlodovi())
                     .commit();
         }
