...
public class ResursiMehanizacija extends Fragment {
    View view;
    ...
    private ResursiRecycler resursiMehanizacijaRecycler;
    ...
    private Button btnDodajdMehanizaciju;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_resursi_mehanizacija, container, false);
        ...
        btnDodajdMehanizaciju = (Button) view.findViewById(R.id.buttonDodajResurs);
        ...
        resursiMehanizacijaRecycler = new ResursiRecycler(listaResursa, relativeLayout2, editVrsta2, editKolicina2, btnDodajdMehanizaciju, btnCancel2, btnDodaj2, btnObrisi2);

        recyclerView.setLayoutManager(new LinearLayoutManager(container.getContext()));
        recyclerView.setAdapter(resursiMehanizacijaRecycler);
        ...
        btnDodajdMehanizaciju.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void dodajResurs(){
        ...
        mapObjekat.put("tip", "mehanizacija");
