...
public class ResursiNjive extends Fragment {
    View view;
    ...
    private ResursiRecycler resursiNjivaRecycler;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_resursi_njive, container, false);
        ...
        btnDodajNjivu = (Button) view.findViewById(R.id.buttonDodajResurs);
        ...
        resursiNjivaRecycler = new ResursiRecycler(listaResursa, relativeLayout2, editVrsta2, editKolicina2, btnDodajNjivu, btnCancel2, btnDodaj2, btnObrisi2);

        recyclerView.setLayoutManager(new LinearLayoutManager(container.getContext()));
        recyclerView.setAdapter(resursiNjivaRecycler);
        ...
        btnDodajNjivu.setOnClickListener(new View.OnClickListener() {
            @Override
