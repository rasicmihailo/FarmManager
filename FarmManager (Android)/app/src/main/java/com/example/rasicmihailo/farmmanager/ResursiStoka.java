...
public class ResursiStoka extends Fragment {
    ...
    private ResursiRecycler resursiStokaRecycler;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_resursi_stoka, container, false);
        ...
        btnDodajStoku = (Button) view.findViewById(R.id.buttonDodajResurs);
        ...
        resursiStokaRecycler = new ResursiRecycler(listaResursa, relativeLayout2, editVrsta2, editKolicina2, btnDodajStoku, btnCancel2, btnDodaj2, btnObrisi2);

        recyclerView.setLayoutManager(new LinearLayoutManager(container.getContext()));
        recyclerView.setAdapter(resursiStokaRecycler);
                                            ...
                                            for(DocumentChange doc : queryDocumentSnapshots.getDocumentChanges()){
                                                if(doc.getType() == DocumentChange.Type.ADDED){
                                                    ...
                                                    if(tip.matches("stoka")) {
                                                        ...
                                                        resursiStokaRecycler.notifyDataSetChanged();
                                                    }
                                                }
                                            }
        ...
        btnDodajStoku.setOnClickListener(new View.OnClickListener() {
            @Override
